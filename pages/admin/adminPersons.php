                ...
                <div class="contentAction">
                    <div class="flex-acenter titleAction">
                        <div class="actionText">
                            <p>Persons Dashboard</p>
                            <p>Running tasks for Persons</p>
                        </div>
                        <div>
                            <button id="btnAddNew" class="btnAdd" onclick="showAddNewForm('formAddNewPerson')">Add new</button>
                        </div>
                    </div>
